...
int main() {
    ...
    parser_types::AST res_ast = parser::grammer_check(tok_it);
    std::vector<access_methods_types::row_t> r = planner::select_plan(operators, buff_pool, access_methods, res_ast);
